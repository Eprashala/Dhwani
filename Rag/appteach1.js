...
async function getAIResponse(history) {
    ...
    if (isBookMode) {
        ...
        const topChunks = retrieveRelevantChunks(userQuery, 4);
        ...
        Answer the user's questions strictly and faithfully based ONLY on the following retrieved book excerpts. 
        Always mention the relevant page number(s) in your answer.
        Keep your response highly conversational, clear, and direct so it sounds natural when spoken aloud by a TTS engine.
        Do NOT use complex LaTeX. Use Markdown for basic formatting.
